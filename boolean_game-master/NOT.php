...
<head>
  <meta charset="utf-8">
  <title>Boolean NOT | Boolean Operators Tutorial</title>
  <meta name="author" content="Charles Seymour">
  <meta name="description" content="Explanation of Boolean operator NOT, with game to test understanding">
...
<h2>What is Boolean NOT?</h2>
<p>When you use Boolean NOT, the database looks for documents that contain the search term before the NOT but which do not have the search term after the NOT.  For instance, if you type:</p>

<p><strong>education NOT college</strong></p>

<p>into the database, you will get items that have the word "education" but which do not have the word "college".</p>

<p>This means that using NOT will usually decrease the number of results you get.  Like AND, NOT makes your search more precise.  But whereas AND makes your search more precise by including a second term, NOT does it by excluding a second term.</p>

<p>Using NOT is a good idea when you want to get rid of irrelevant results that contain a search term you're not interested in.</p>

<p>When using NOT in the databases, it is highly recommended that you change the menu in the LAST row to NOT and then put the excluded term in the last row, as in the image below:</p>

<img src="images/ebsco_not.png" alt="Database search boxes with Boolean menus" width="187" height="118">
<p>Try the card game on this page to practice the Boolean NOT.</p>
...
<div id="explanation">
  ...
  <script>
    ...
    var onButtonClick = function() {
      ...
      var t = document.createTextNode("Boolean statement" + " " + ":" + " " + left_hand + " " + "NOT" + " " + right_hand);
      x.appendChild(t);
